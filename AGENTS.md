...
- Todo novo texto visível, `title`, `aria-label`, `alt`, placeholder, metadado e mensagem de ação deve ter traduções completas em `site/i18n.js` para os três idiomas. Não introduza texto fixo em um único idioma.
